...
import { AdminSignupMasterService } from '../../admin/admin-dashboard/admin-signup-master/admin-signup-master.service';
import { LoginService } from '../../Login/login.service';
import { AdminSignupMaster } from '../../models/admin-signup-master';
import { CityMasterList } from '../../models/city-master';
import { RootUserSave } from '../../models/user';
import { CustomerSignupService } from '../../SignUp/customer-signup/customer-signup.service';
@Component({
  selector: 'app-assistant-sign-up',
  templateUrl: './assistant-sign-up.component.html',
  styleUrls: ['./assistant-sign-up.component.scss']
})
export class AssistantSignUpComponent implements OnInit {
  ...
  submitCustomerSignup() {
    if (this.verifiedMobileText == true) {
      this.loader = true;
      let addSignupMasterModel = {
        nLoggedInUserId:parseInt(this.storageService.userId!!),
      ...
      this.adminSignupMasterService.CorporateAssistantSignUp_Insert(addSignupMasterModel).subscribe((status: any) => {
