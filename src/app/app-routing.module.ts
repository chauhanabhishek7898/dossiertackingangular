...
const routes: Routes = [
  ...
  {path: "", component: MainsiteComponent, children: [
      ...
      {path: 'refundandcancellationpolicy', component: RefunandCancellationPolicyComponent},
      {path: 'deliveryandshippingploicy', component: DeliveryAndShippingPloicyComponent},
